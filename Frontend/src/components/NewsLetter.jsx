...
const NewsLetter = () => {
  return (
    <section className="py-20 px-10 md:px-40 gap-0 flex flex-col md:flex-row items-center justify-between text-black">
      <div className="text-center md:text-left mb-6 md:mb-0">
        <h2 className="text-4xl font-bold text-gray-800 pro-name">Stay Updated on Our Latest Offers</h2>
        <p className="text-lg mt-4 text-gray-600 pro-name">Sign up for our newsletter to receive exclusive deals and updates.</p>
      </div>
