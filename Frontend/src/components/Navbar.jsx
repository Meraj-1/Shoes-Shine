    ...
    <div className="flex items-center justify-between font-medium relative">
      ...
      <ul className="hidden sm:flex gap-5 text-sm ">
        <NavLink to="/" className="flex flex-col items-center gap-1 group">
          ...
          <hr className="w-3/4 border-none h-[1.2px] bg-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        </NavLink>
          ...
          <div className="hidden group-hover:block absolute right-0 pt-4 z-50">
            <div className="flex flex-col gap-2 w-36 py-3 px-5  text-gray-500 rounded ">
              {isLoggedIn ? (
                ...
                <>
                  {/* <Link to="/sign-in" className="cursor-pointer hover:text-black">
            Login
          </Link> */}
                  <Link
                    to="/create-user"
