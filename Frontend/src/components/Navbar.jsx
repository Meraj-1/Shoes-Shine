  ...
  return (
    <div className="flex items-center justify-between font-medium relative">
      ...
      <Link to="/" className="flex items-center justify-center">
        <h2 className="sm:text-3xl text-2xl Main">Shoes Shine</h2>
      </Link>
      ...
      {visible && (
        <div className="fixed  inset-0 z-10 bg-[#ffffff]">
          <div
            className={`fixed top-0 right-0 h-full w-full transition-transform transform ${
              visible ? "translate-x-0" : "translate-x-full"
            }`}
          >
            <div
              onClick={() => setVisible(false)}
              className=" flex mt-10 gap-2 ml-6 cursor-pointer"
            >
