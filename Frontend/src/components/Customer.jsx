...
const Customer = () => {
  return (
    <section className="py-20 px-10 md:px-40  mt-20 text-black">
      <h2 className="text-4xl font-bold text-center text-gray-800 mb-12 pro-name">Customer Support<hr className='mt-3 bg-gray-600 border-none h-px'/> </h2>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        {/* Live Chat */}
        <div className="bg-white p-6  ">
            <i class="fa-solid fa-headset text-5xl text-black mb-4"></i>
